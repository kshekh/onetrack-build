...
<div class="relative w-full ">
	...
	{#if showDropdown}
		<div
			transition:slide
			class="absolute mt-2 inset-x-0 z-40  top-full rounded-b-md bg-color focus:outline-none text-sm before:absolute before:bg-dropdown before:backdrop-blur-2.5xl before:rounded-b-md before:shadow-dropdown before:opacity-60 before:inset-0 -mx-3"
			tabindex="-1"
			role="listbox"
			aria-labelledby="listbox-label"
